...
const config: Config = {
    ...
    theme: {
        ...
        fontSize: {
            ...
            title4: ['min(3.6vw, 1.1rem)', { letterSpacing: "0.24rem", lineHeight:"1.8rem", fontWeight: "400" }],
            title3: ['min(4vw, 1.3rem)', { letterSpacing: "0.24rem", lineHeight:"2rem", fontWeight: "400" }],
            title2: ['min(4.5vw, 1.6rem)', { letterSpacing: "0.24rem" , lineHeight:"2.2rem", fontWeight: "400"}],
            title1: ['min(5vw, 2.2rem)', { letterSpacing: "0.24rem" , lineHeight:"2.4rem", fontWeight: "400"}],
        },
        screens: {
            sm: '600px',
            md: '1240px',
